import { type ShortformVideoProps } from '@/components/portfolio/ShortformVideoCard';

// Shortform video data with local video files
export const shortformVideos: ShortformVideoProps[] = [
  {
    videoUrl: '/shortformvideos/viralReelCred1 (1).mp4',
    originalSource: 'https://www.youtube.com/shorts/ZfBIsye4svo'
  },
  {
  ...
  },
  {
    ...
    originalSource: 'https://www.instagram.com/alekhya_kathi'
  },
  {
    videoUrl: '/shortformvideos/viral-instagram-hacks-13.mp4',
    originalSource: 'https://www.instagram.com/p/DFs6jZTonp0/'
  },
  {
    videoUrl: '/shortformvideos/viral-web3-crypto-talking-head-14.mp4',
    originalSource: 'https://www.instagram.com/p/DFsTWvVIA8r/'
  },
  {
